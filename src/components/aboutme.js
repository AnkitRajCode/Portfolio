         ...
         <div className="about_me" id="aboutme">
            ...
            <div className="intro">
               ...
               <p className="intro_details">
                  ...
                  I learned MERN Stack 1 year ago and work on 2-3 different projects based on it.
                  ...
                  I am a web dev. lead where I and my team are working on various projects which are also helping me to grow in this field.
               </p>
               <a href="https://drive.google.com/file/d/12FsP05ea6IUXy-ZT706pBaThjBYNTgeR/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="code_button"><i class="fas fa-download"></i> Resume</a>
            </div>
        </div>
      )
   }
